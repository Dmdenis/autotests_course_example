...
def treatment_sum(our_tuple):
    """
    Функция складывает два элемента кортежа, возвращает исключение при не совпадении типа данных
    :param our_tuple: кортеж состоящий из двух элементов
    :return: сумму двух элементов кортежа; исключение в случае различных типов данных.
    """
